...
def main(args):
    ...
    try:
        ...
        for gamma_iter in range(1):
            ...
            if gamma_type == 'LSTM':
                ...
                str_supercloud_data = './supercloud_data/CF_gamma_LSTM_output' + str(y_state) + '_sigmoid.pth'
                ...
                str_supercloud_data = './supercloud_data/CF_gamma_deep_output' + str(y_state) + '_sigmoid.pth'
            else:
                NotImplementedError
    ...
    plot_name = './plots/' + 'CF_gamma_compare_all_output_NN_no_CNN' + '.png'
    ...
    torch.save(acc_final, './log_files/acc_final_NN_output.pt')
